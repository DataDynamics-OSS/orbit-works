...
export const MENU_REGISTRY: MenuEntry[] = [
  ...
  { key: "emails", label: "메일", href: "/email", group: "홈" },
  ...
  { key: "domains", label: "도메인", href: "/domains", group: "자원" },
  { key: "server_hostings", label: "서버 호스팅", href: "/server-hostings", group: "자원" },
  ...
  { key: "utilization", label: "임직원 가동율", href: "/utilization", group: "인사" },
